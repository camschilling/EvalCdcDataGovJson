...
def resolve_class(
    qualified_class_name: str, package_dir: Optional[Mapping[str, str]] = None, root_dir: Optional[_Path] = None
) -> Callable:
...
def cmdclass(
    values: Dict[str, str], package_dir: Optional[Mapping[str, str]] = None, root_dir: Optional[_Path] = None
) -> Dict[str, Callable]:
...
def find_packages(
    *, namespaces=True, fill_package_dir: Optional[Dict[str, str]] = None, root_dir: Optional[_Path] = None, **kwargs
) -> List[str]:
